...
public struct RangedSlider: View {
    ...
    public var body: some View {
        sliderView(sliderSize: CGSize(width: geometryInfo.width, height: geometryInfo.width))
    }
    ...
    @ViewBuilder func thumbView(position: CGPoint, value: Float) -> some View {
        ZStack {
            Text(String(value))
                .font(SharedFontFamily.Pretendard.semiBold.swiftUIFont(size: 10))
                .offset(y: -20)
            Circle()
